...
export async function retrieveContext(queryText, topK = 8, whereFilter = null, opts = {}) {
  const { exam = null, year = null, state = null, instTokens = null } = opts || {};
...
export async function retrieveJeeContext(queryText, topK = 10, opts = {}) {
  const {
    ...
    exam = null, year = null, state = null, instTokens = null,
  } = opts;
  const supabase = getSupabase();
  const embedding = await embedQuery(queryText);
...
export async function retrieveKcetContext(queryText, topK = 10, opts = {}) {
  const { rankField = null, rank = null, round = null, exam = null, year = null, state = null, instTokens = null } = opts;
  const supabase = getSupabase();
  const embedding = await embedQuery(queryText);
