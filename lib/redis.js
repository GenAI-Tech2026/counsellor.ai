...
// Redis is intentionally DISABLED. Every caller falls back to its non-Redis
// path (Postgres rate-limit, direct embedding, no response cache). Flip this
// back to `Boolean(REST_URL && REST_TOKEN)` to re-enable Upstash.
