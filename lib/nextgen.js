...
const ALIASES = {
  niat: ['niat', 'nxtwave', 'nxt wave', 'nxtwave institute', 'institute of advanced technologies', 'niat program', 'nxtwave program', 'innovation in advanced technologies', 'nxtwave of innovation in advanced technologies', 'nxtwave institute of advanced technologies'],
  scaler: ['scaler', 'sst', 'scaler school', 'scaler school of technology'],
  polaris: ['polaris', 'polaris school', 'polaris technology'],
  newton: ['newton school', 'newton school of technology', 'nst', 'rishihood'],
  plaksha: ['plaksha', 'plaksha university'],
};
