...
// indigo #6366f1/#4f46e5/#3730a3, emerald #0e9f6e, amber #f4a83b, muted #6b6b80.
    ...
    >
      ...
      <g>
        ...
        <g filter="url(#data_shadow)">
          ...
          <rect x="104" y="116" width="120" height="8" rx="4" fill="#6366f1" opacity="0.18">
    ...
    >
      ...
      <g>
        ...
        <g filter="url(#match_shadowSm)">
          ...
          <circle cx="160" cy="218" r="11" fill="none" stroke="#6366f1" strokeWidth="2">
    ...
    >
      ...
      <g>
        ...
        <g filter="url(#profile_shadow)">
          ...
          <rect x="156" y="122" width="42" height="8" rx="4" fill="#4f46e5" opacity="0.85" />
          {/* Rank */}
          ...
          <rect x="156" y="146" width="34" height="8" rx="4" fill="#4f46e5" opacity="0.85" />
          {/* Category */}
          ...
          <rect x="156" y="170" width="50" height="8" rx="4" fill="#4f46e5" opacity="0.85" />
        </g>
