    ...
    >
      <defs>
        ...
        <radialGradient id="journey_ring" cx="0.5" cy="0.5" r="0.5">
          ...
          <stop offset="0.85" stopColor="#6366f1" stopOpacity="0.35" />
          <stop offset="1" stopColor="#6366f1" stopOpacity="0" />
        </radialGradient>

        <radialGradient id="journey_dotGrad" cx="0.5" cy="0.5" r="0.5">
          <stop offset="0" stopColor="#ffffff" />
          <stop offset="0.4" stopColor="#a5b4fc" />
      ...
      <g>
        ...
        <g>
          ...
          <g transform="translate(150 120)">
            <path
              ...
              filter="url(#journey_shadowSoft)"
            />
            <circle cx="9" cy="0" r="3" fill="#4f46e5" />
            <rect x="-12" y="-4" width="14" height="3.2" rx="1.6" fill="#6366f1" />
            <rect x="-12" y="2" width="9" height="3.2" rx="1.6" fill="#a5b4fc" />
          </g>
          <text
            x="150"
            y="190"
        ...
        <g>
          ...
          <g transform="translate(360 120)">
            <path
              ...
              filter="url(#journey_shadowSoft)"
            />
            <rect x="-22" y="-18" width="44" height="6" rx="3" fill="#3730a3" />
        ...
        <g>
          ...
          <g transform="translate(570 120)">
            ...
            <rect x="-12" y="11" width="8" height="6" rx="2" fill="#6366f1" />
