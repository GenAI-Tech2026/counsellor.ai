  ...
  return (
    <div className={styles.previewCard}>
      <div className={styles.previewHead}>
        ...
        <Image src="/branding/counsa_logo_mini.png" alt="" width={18} height={18} unoptimized className={styles.previewLogo} />
        <span className={styles.previewTitle}>counsa.ai</span>
      </div>
      <div className={styles.previewBody}>
        <div className={styles.pUser}>JEE rank 12,000, OBC-NCL, male — CSE options?</div>
        <div className={styles.pBotRow}>
          <span className={styles.pBotAvatar}><Image src="/branding/counsa_logo_mini.png" alt="counsa.ai" width={16} height={16} unoptimized /></span>
