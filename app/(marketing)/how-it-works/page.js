...
const STEPS = [
  ...
  { icon: ListChecks, title: 'We match the data', text: 'We search official cutoffs filtered to your exact profile, so only the colleges and branches you’re eligible for surface.' },
