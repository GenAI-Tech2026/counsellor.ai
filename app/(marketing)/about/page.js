...
export const metadata = {
  title: 'About — counsa.ai',
  description: 'Why counsa.ai exists: fair, data-grounded admission counselling for every student.',
};
    ...
    <>
      ...
      <section className={styles.section} style={{ paddingTop: '1.5rem' }}>
        <Reveal className={styles.prose}>
          ...
          <p>
            <strong>counsa.ai</strong> exists to close that gap. It speaks plain
            language, understands your exam, rank, category and preferences, and matches them
            against the same official JoSAA and state-CET data the experts rely on — so the
