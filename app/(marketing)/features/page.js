...
export const metadata = {
  title: 'Features — Admission Mantrana',
  description: 'Everything Admission Mantrana does: official-data answers, profile personalization, saved & searchable sessions, and more.',
};

const FEATURES = [
  { icon: Database, title: 'Built on official 2025 data', text: 'Every answer is grounded in TGEAPCET 2025 last-rank statements and JEE Main 2025 JoSAA (final round) — not guesswork.' },
