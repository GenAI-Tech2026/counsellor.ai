...
const FEATURE_STORIES = [
  { Art: DataStack, eyebrow: 'Grounded', title: 'Built on official data.', text: 'Every answer comes from TGEAPCET & JEE JoSAA 2025 cutoffs — never guesswork, never hype.' },
    ...
    <>
      ...
      <header className={styles.hero}>
        ...
        <div className={styles.heroCopy}>
          ...
          <p className={styles.heroLede}>
            Tell Admission Mantrana your exam and rank — it reads the official cutoffs and
      ...
      <section className={styles.stats}>
        <div className={styles.stat}>
          <span className={styles.statNum}><CountUp to={2} /></span>
          <span className={styles.statLabel}>exams covered<br />TGEAPCET &amp; JEE</span>
        </div>
        <div className={styles.statDivider} />
        <div className={styles.stat}>
          <span className={styles.statNum}><CountUp to={2025} plain /></span>
          <span className={styles.statLabel}>official cutoffs<br />latest round</span>
        </div>
        <div className={styles.statDivider} />
        <div className={styles.stat}>
          <span className={styles.statNum}>1000s</span>
          <span className={styles.statLabel}>college-branch<br />records</span>
        </div>
        <div className={styles.statDivider} />
        <div className={styles.stat}>
